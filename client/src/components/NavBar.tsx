...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-3">
      <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-black bg-opacity-90 sticky top-3 shadow lg:px-8 backdrop-blur-lg backdrop-saturate-150 z-[9999]">
        <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
          ...
          >
            ...
            <ul className="flex flex-col h-full gap-4 p-4">
              ...
              <li className="mt-4">
                <button className="bg-gray-500 text-white hover:text-black px-4 py-2 rounded-md hover:bg-white w-1/2">
          ...
          <div className="hidden lg:block">
            <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
              ...
              <li>
                <button className="bg-gray-500 hover:bg-gray-300 text-white hover:text-black px-4 py-2 rounded-md">
                    <Link href="/">Start Booking</Link>
                </button>
              </li>
            </ul>
